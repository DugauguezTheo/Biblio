...
//         return new Genre().id(1L).libelle("libelle1");
//     }

//     public static Genre getGenreSample2() {
//         return new Genre().id(2L).libelle("libelle2");
//     }

//     public static Genre getGenreRandomSampleGenerator() {
//         return new Genre().id(longCount.incrementAndGet()).libelle(UUID.randomUUID().toString());
//     }
// }
